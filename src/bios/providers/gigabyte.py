...
Gigabyte BIOS Provider

Provides firmware support for Gigabyte desktop,
motherboard, and workstation platforms.

This provider identifies Gigabyte firmware and
exposes firmware capabilities through the common
...
class GigabyteProvider(DefaultBIOSProvider):
    """
    BIOS provider for Gigabyte systems.
    """
    ...
    def detect(self) -> bool:
        ...
        return self.firmware_information.is_gigabyte
    ...
    def set_boot_mode_uefi(self) -> bool:
        """
        Placeholder for future Gigabyte firmware
        integration.
        """
    ...
    def to_dict(self) -> dict[str, object]:
        ...
        data["provider"] = "GigabyteProvider"
        data["vendor"] = "Gigabyte"
