...
Provides firmware support for Acer desktop and laptop
systems.

This provider identifies Acer firmware and exposes
...
class AcerProvider(DefaultBIOSProvider):
    """
    BIOS provider for Acer systems.
    """
    ...
    def detect(self) -> bool:
        ...
        return self.firmware_information.is_acer
    ...
    def set_boot_mode_uefi(self) -> bool:
        """
        Placeholder for future Acer firmware support.
        """
        return False
