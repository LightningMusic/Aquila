...
Provides firmware support for ASUS desktop and laptop
systems.

This provider identifies ASUS firmware and exposes
...
class ASUSProvider(DefaultBIOSProvider):
    """
    BIOS provider for ASUS systems.
    """
    ...
    def detect(self) -> bool:
        ...
        return self.firmware_information.is_asus
    ...
    def set_boot_mode_uefi(self) -> bool:
        """
        Future implementation using ASUS WMI/BIOS
