...
class GenericUEFIProvider(DefaultBIOSProvider):
    """
    Generic provider for UEFI firmware.
    """
    ...
    def detect(self) -> bool:
        ...
        return self.firmware_information.is_uefi
    ...
    def to_dict(self) -> dict[str, object]:
        ...
        data["provider"] = "GenericUEFIProvider"
        data["vendor"] = "Generic UEFI"
