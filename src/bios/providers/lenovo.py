...
Lenovo BIOS Provider

Provides firmware support for Lenovo desktop, laptop,
and workstation systems.

This provider identifies Lenovo firmware and exposes
...
class LenovoProvider(DefaultBIOSProvider):
    """
    BIOS provider for Lenovo systems.
    """
    ...
    def detect(self) -> bool:
        ...
        return self.firmware_information.is_lenovo
    ...
    def set_boot_mode_uefi(self) -> bool:
        """
        Placeholder for future Lenovo BIOS WMI
        integration.
        """
