...
Provides firmware support for Framework laptops.

Framework systems expose a modern UEFI firmware and
are designed to be Linux-friendly. This provider
identifies Framework firmware and exposes firmware
capabilities through the common BIOSProvider
interface.
...
class FrameworkProvider(DefaultBIOSProvider):
    """
    BIOS provider for Framework systems.
    """
    ...
    def detect(self) -> bool:
        ...
        return self.firmware_information.is_framework
    ...
    def set_boot_mode_uefi(self) -> bool:
        """
        Placeholder for future Framework firmware
        integration.
        """
    ...
    def to_dict(self) -> dict[str, object]:
        ...
        data["provider"] = "FrameworkProvider"
