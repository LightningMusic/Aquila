...
Provides firmware support for HP and Hewlett-Packard
desktop and laptop systems.

This provider identifies HP firmware and exposes
...
class HPProvider(DefaultBIOSProvider):
    """
    BIOS provider for HP systems.
    """
    ...
    def detect(self) -> bool:
        ...
        return self.firmware_information.is_hp
    ...
    def set_boot_mode_uefi(self) -> bool:
        """
        Placeholder for future HP BIOS Configuration
        Utility integration.
        """
